...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
        ...
        <xsl:element name="section">
            <xsl:attribute name="id">sectionOneMeal</xsl:attribute>
            ...
            <div class="container">
                <xsl:element name="h1">
                    <xsl:attribute name="id">Meal</xsl:attribute>
                ...
                <div id="contentOneMeal" class=" mx-auto py-md-2 h-auto mx-md-5 d-md-block d-none">
                    <div class="mx-md-5">
                        <xsl:element name="h2">
        ...
        <xsl:element name="section">
            <xsl:attribute name="id">sectionOneMeal-mobile</xsl:attribute>
            ...
            <div class="container">
                ...
                <div id="contentOneMeal-mobile" class="d-block d-md-none d-flex flex-row overflow-auto mt-5  h-auto">
                    <xsl:for-each select="hero_menu">
                        <xsl:element name="div">

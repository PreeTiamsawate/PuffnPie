            ...
            <xsl:choose>
                <xsl:when test="($position mod 2) = 1">
                    ...
                    <section class="sectionBox py-lg-5 py-md-3 py-2 w-100 h-auto">
                        <div class="container-fluid mx-auto px-lg-0 row">
                            ...
                            <div class="col-md-6 col-12 px-0 px-md-2 overflow-visible">
                                ...
                                <div class="box-content mt-lg-4 mt-3 d-md-block d-none">
                                    <xsl:value-of select="######" disable-output-escaping="yes" />
                                </div>
                    ...
                    <section class="sectionBox py-md-5  py-2 w-100 h-auto">
                        <div class="container-fluid mx-auto px-lg-0 row">
                            ...
                            <div class="col-md-6 col-12 px-0 px-md-2 overflow-visible">
                                ...
                                <div class="box-content mt-4 text-end d-md-block d-none ">
                                    <xsl:value-of select="######" disable-output-escaping="yes" />
                                </div>
